...
#
# sudo ./docker_build_and_run.sh ~/steemit/steem/build/Release/programs/blurtd ~/steemit/steem/build/Release/programs/blurtd ~/steemit/blurtd_data/steemnet ~/steemit/blurtd_data/steemnet ~/steemit/logs 5000000 12

if [ $# -lt 6 -o $# -gt 8 ]
then
   echo "Usage: reference_blurtd_location tested_blurtd_location ref_blockchain_folder_location tested_blockchain_folder_location"
   echo "       logs_dir stop_replay_at_block [jobs [--dont-copy-config]"
   echo "Example: ~/steemit/ref_blurtd ~/steemit/steem/build/Release/programs/blurtd ~/steemit/steemnet ~/steemit/testnet"
