...
- Miner queue length very approximately modeled (assumed to go to 100 during the first blocks and then stay there) (may lower or raise BLURT supply, very small)
- Creation / destruction of BLURT used to back SBD not modeled (moves BLURT supply in direction opposite to changes in dollar value of 1 BLURT, large)
- Interest paid to SBD not modeled (raises BLURT supply, medium)
- Lost / forgotten private keys / wallets and deliberate burning of BLURT not modeled (lowers BLURT supply, unknown but likely small)
