...
namespace blurt { namespace chain {
   ...
   using blurt::protocol::weight_type;
   ...
   {
      BLURT_STD_ALLOCATOR_CONSTRUCTOR( shared_authority )
...
FC_REFLECT_TYPENAME( blurt::chain::shared_authority::account_authority_map)
FC_REFLECT( blurt::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
