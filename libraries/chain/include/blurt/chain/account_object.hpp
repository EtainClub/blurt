...
namespace blurt { namespace chain {
   ...
   using blurt::protocol::authority;

   class account_object : public object< account_object_type, account_object >
   {
         BLURT_STD_ALLOCATOR_CONSTRUCTOR( account_object )
         ...
         account_name_type reset_account = BLURT_NULL_ACCOUNT;
         ...
         asset             balance = asset( 0, BLURT_SYMBOL );  ///< total liquid shares held by this account
         asset             savings_balance = asset( 0, BLURT_SYMBOL );  ///< total liquid shares held by this account
         ...
         fc::array<share_type, BLURT_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( BLURT_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
   ...
   {
      BLURT_STD_ALLOCATOR_CONSTRUCTOR( account_metadata_object )
   ...
   {
      BLURT_STD_ALLOCATOR_CONSTRUCTOR( account_authority_object )
   ...
   {
      BLURT_STD_ALLOCATOR_CONSTRUCTOR( owner_authority_history_object )
   ...
   {
      BLURT_STD_ALLOCATOR_CONSTRUCTOR( account_recovery_request_object )
   ...
   {
      BLURT_STD_ALLOCATOR_CONSTRUCTOR( change_recovery_account_request_object )
...
template<> struct is_static_length< blurt::chain::account_object > : public boost::true_type {};
template<> struct is_static_length< blurt::chain::vesting_delegation_object > : public boost::true_type {};
template<> struct is_static_length< blurt::chain::vesting_delegation_expiration_object > : public boost::true_type {};
template<> struct is_static_length< blurt::chain::change_recovery_account_request_object > : public boost::true_type {};

} // mira
#endif

FC_REFLECT( blurt::chain::account_object,
...
CHAINBASE_SET_INDEX_TYPE( blurt::chain::account_object, blurt::chain::account_index )

FC_REFLECT( blurt::chain::account_metadata_object,
             (id)(account)(json_metadata)(posting_json_metadata) )
CHAINBASE_SET_INDEX_TYPE( blurt::chain::account_metadata_object, blurt::chain::account_metadata_index )

FC_REFLECT( blurt::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( blurt::chain::account_authority_object, blurt::chain::account_authority_index )

FC_REFLECT( blurt::chain::vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( blurt::chain::vesting_delegation_object, blurt::chain::vesting_delegation_index )

FC_REFLECT( blurt::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( blurt::chain::vesting_delegation_expiration_object, blurt::chain::vesting_delegation_expiration_index )

FC_REFLECT( blurt::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( blurt::chain::owner_authority_history_object, blurt::chain::owner_authority_history_index )

FC_REFLECT( blurt::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( blurt::chain::account_recovery_request_object, blurt::chain::account_recovery_request_index )

FC_REFLECT( blurt::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( blurt::chain::change_recovery_account_request_object, blurt::chain::change_recovery_account_request_index )
