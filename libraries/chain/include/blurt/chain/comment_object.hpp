...
namespace blurt { namespace chain {
   ...
   {
      BLURT_STD_ALLOCATOR_CONSTRUCTOR( comment_object )
      ...
      public:
         ...
         /** tracks the total payout this comment has received over time, measured in BLURT_SYMBOL */
         asset             total_payout_value = asset(0, BLURT_SYMBOL);
         asset             curator_payout_value = asset(0, BLURT_SYMBOL);
         asset             beneficiary_payout_value = asset( 0, BLURT_SYMBOL );
   ...
   {
      BLURT_STD_ALLOCATOR_CONSTRUCTOR( comment_content_object )
   ...
   {
      BLURT_STD_ALLOCATOR_CONSTRUCTOR( comment_vote_object )
...
template<> struct is_static_length< blurt::chain::comment_vote_object > : public boost::true_type {};

} // mira
#endif

FC_REFLECT( blurt::chain::comment_object,
             (id)(author)(permlink)
...
CHAINBASE_SET_INDEX_TYPE( blurt::chain::comment_object, blurt::chain::comment_index )

FC_REFLECT( blurt::chain::comment_content_object,
            (id)(comment)(title)(body)(json_metadata) )
CHAINBASE_SET_INDEX_TYPE( blurt::chain::comment_content_object, blurt::chain::comment_content_index )

FC_REFLECT( blurt::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( blurt::chain::comment_vote_object, blurt::chain::comment_vote_index )

namespace helpers
{
   using blurt::chain::shared_string;

   template <>
   class index_statistic_provider<blurt::chain::comment_index>
   {
   public:
      typedef blurt::chain::comment_index IndexType;
      typedef typename blurt::chain::comment_object::t_beneficiaries t_beneficiaries;
   ...
   template <>
   class index_statistic_provider<blurt::chain::comment_content_index>
   {
   public:
      typedef blurt::chain::comment_content_index IndexType;
