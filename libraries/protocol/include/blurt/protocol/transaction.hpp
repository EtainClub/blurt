...
#include <blurt/protocol/sign_state.hpp>
...
using fc::ecc::canonical_signature_type;
   ...
   struct signed_transaction : public transaction
   {
      ...
      set<public_key_type> get_required_signatures(
         ...
         uint32_t max_recursion = BLURT_MAX_SIG_CHECK_DEPTH,
         uint32_t max_membership = BLURT_MAX_AUTHORITY_MEMBERSHIP,
         uint32_t max_account_auths = BLURT_MAX_SIG_CHECK_ACCOUNTS,
...
FC_REFLECT( blurt::protocol::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( blurt::protocol::signed_transaction, (blurt::protocol::transaction), (signatures) )
FC_REFLECT_DERIVED( blurt::protocol::annotated_signed_transaction, (blurt::protocol::signed_transaction), (transaction_id)(block_num)(transaction_num) );
