...
FC_REFLECT( blurt::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( blurt::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
