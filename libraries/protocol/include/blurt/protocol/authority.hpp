 ...
 * - Length is between (inclusive) BLURT_MIN_ACCOUNT_NAME_LENGTH and BLURT_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace blurt::protocol


FC_REFLECT_TYPENAME( blurt::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( blurt::protocol::authority::key_authority_map)
FC_REFLECT( blurt::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( blurt::protocol::authority::classification, (owner)(active)(key)(posting) )
