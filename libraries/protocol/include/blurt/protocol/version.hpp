...
FC_REFLECT( blurt::protocol::version, (v_num) )
FC_REFLECT_DERIVED( blurt::protocol::hardfork_version, (blurt::protocol::version), )

FC_REFLECT( blurt::protocol::hardfork_version_vote, (hf_version)(hf_time) )
