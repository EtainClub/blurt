...
//
// Place BLURT_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define BLURT_DEFINE_OPERATION_TYPE( OperationType )                       \
                                                                           \
namespace blurt { namespace protocol {                                     \
                                                                           \
void operation_validate( const OperationType& op )                         \
{                                                                          \
   op.visit( blurt::protocol::operation_validate_visitor() );              \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( blurt::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* blurt::protocol */
