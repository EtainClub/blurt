...
#include <blurt/protocol/fixed_string.hpp>
...
namespace blurt {
   ...
   namespace protocol {
      ...
      #define BLURT_INIT_PUBLIC_KEY (blurt::protocol::public_key_type(BLURT_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const blurt::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  blurt::protocol::public_key_type& vo );
    void to_variant( const blurt::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, blurt::protocol::extended_public_key_type& vo );
    void to_variant( const blurt::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, blurt::protocol::extended_private_key_type& vo );
}

FC_REFLECT( blurt::protocol::public_key_type, (key_data) )
FC_REFLECT( blurt::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( blurt::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( blurt::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( blurt::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( blurt::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( blurt::protocol::share_type )

FC_REFLECT( blurt::void_t, )
