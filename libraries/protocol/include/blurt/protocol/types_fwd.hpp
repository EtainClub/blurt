...
template< typename Stream, typename Storage >
inline void unpack( Stream& s, blurt::protocol::fixed_string_impl< Storage >& u, uint32_t depth = 0 );
...
inline void to_variant( const blurt::protocol::fixed_string_impl< Storage >& s, fc::variant& v );
template< typename Storage >
inline void from_variant( const variant& v, blurt::protocol::fixed_string_impl< Storage >& s );
