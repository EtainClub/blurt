...
namespace blurt { namespace protocol {
   ...
   struct escrow_transfer_operation : public base_operation
   {
      ...
      asset             steem_amount = asset( 0, BLURT_SYMBOL );
      asset             fee;
   ...
   struct escrow_release_operation : public base_operation
   {
      ...
      uint32_t          escrow_id = 30;
      asset             steem_amount = asset( 0, BLURT_SYMBOL ); ///< the amount of steem to release
   ...
   struct legacy_chain_properties
   {
       ...
       */
      legacy_steem_asset account_creation_fee = legacy_steem_asset::from_amount( BLURT_MIN_ACCOUNT_CREATION_FEE );
      ...
      void validate()const
      {
         ...
         FC_ASSERT( account_creation_fee.amount >= BLURT_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= BLURT_MIN_BLOCK_SIZE_LIMIT);
      }
   };
   ...
   struct witness_set_properties_operation : public base_operation
   {
      ...
      void get_required_authorities( vector< authority >& a )const
      {
         ...
         if( key_itr != props.end() )
         {
            ...
            a.push_back( authority( 1, BLURT_NULL_ACCOUNT, 1 ) ); // The null account auth is impossible to satisfy
      }
   };
...
FC_REFLECT( blurt::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( blurt::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( blurt::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( blurt::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( blurt::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )

FC_REFLECT( blurt::protocol::legacy_chain_properties,
            (account_creation_fee)
            (maximum_block_size)
          )

FC_REFLECT( blurt::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( blurt::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( blurt::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( blurt::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( blurt::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( blurt::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
...
FC_REFLECT( blurt::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( blurt::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( blurt::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )

FC_REFLECT( blurt::protocol::delete_comment_operation, (author)(permlink) );
...
FC_REFLECT( blurt::protocol::escrow_transfer_operation, (from)(to)(steem_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( blurt::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( blurt::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( blurt::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(steem_amount) );
FC_REFLECT( blurt::protocol::claim_account_operation, (creator)(fee)(extensions) );
FC_REFLECT( blurt::protocol::create_claimed_account_operation, (creator)(new_account_name)(owner)(active)(posting)(memo_key)(json_metadata)(extensions) );
FC_REFLECT( blurt::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( blurt::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( blurt::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( blurt::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( blurt::protocol::claim_reward_balance_operation, (account)(reward_steem)(reward_vests) )
