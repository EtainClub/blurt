...
#define STEEM_MIN_PAYOUT                      (asset(20,STEEM_SYMBOL))
...
#define STEEM_HF_19_RECENT_CLAIMS (fc::uint128_t(uint64_t(140797515942543623ull))) // maybe set to current recent claims of the snapshot time ?
