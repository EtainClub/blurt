...
#include <blurt/plugins/raw_block/raw_block_api.hpp>
#include <blurt/plugins/raw_block/raw_block_plugin.hpp>
...
{
   public:
      raw_block_api_impl( blurt::app::application& _app );

      std::shared_ptr< blurt::plugin::raw_block::raw_block_plugin > get_plugin();

      blurt::app::application& app;
};

raw_block_api_impl::raw_block_api_impl( blurt::app::application& _app ) : app( _app )
{}

std::shared_ptr< blurt::plugin::raw_block::raw_block_plugin > raw_block_api_impl::get_plugin()
{
...
raw_block_api::raw_block_api( const blurt::app::api_context& ctx )
{
...
get_raw_block_result raw_block_api::get_raw_block( get_raw_block_args args )
{
   ...
   std::shared_ptr< blurt::chain::database > db = my->app.chain_database();
