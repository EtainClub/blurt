...
#include <blurt/plugins/block_info/block_info_api.hpp>
#include <blurt/plugins/block_info/block_info_plugin.hpp>

namespace blurt { namespace plugin { namespace block_info {
...
{
   public:
      block_info_api_impl( blurt::app::application& _app );

      std::shared_ptr< blurt::plugin::block_info::block_info_plugin > get_plugin();
...
block_info_api_impl::block_info_api_impl( blurt::app::application& _app ) : app( _app )
{}

std::shared_ptr< blurt::plugin::block_info::block_info_plugin > block_info_api_impl::get_plugin()
{
...
block_info_api::block_info_api( const blurt::app::api_context& ctx )
{
