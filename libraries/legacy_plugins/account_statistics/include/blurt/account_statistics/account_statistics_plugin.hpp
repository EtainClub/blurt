...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_total_steem_value = 0;     ///< BLURT Value of author rewards
   ...
   share_type           curation_rewards_steem_value = 0;         ///< BLURT Value of curation rewards
   ...
   share_type           steem_sent = 0;                           ///< BLURT sent from this account
   share_type           steem_received = 0;                       ///< BLURT received by this account
   ...
   share_type           steem_vested = 0;                         ///< BLURT vested by the account
   ...
   share_type           steem_received_from_withdrawls = 0;       ///< BLURT received from this account's vesting withdrawals
   share_type           steem_received_from_routes = 0;           ///< BLURT received from another account's vesting withdrawals
