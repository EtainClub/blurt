...
FC_REFLECT( blurt::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message) )

BLURT_DECLARE_OPERATION_TYPE( blurt::private_message::private_message_plugin_operation )
