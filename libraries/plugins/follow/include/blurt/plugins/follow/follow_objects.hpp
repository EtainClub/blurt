...
#ifndef BLURT_FOLLOW_SPACE_ID
#define BLURT_FOLLOW_SPACE_ID 8
#endif
...
{
   BLURT_STD_ALLOCATOR_CONSTRUCTOR( feed_object );
...
FC_REFLECT_ENUM( blurt::plugins::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( blurt::plugins::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( blurt::plugins::follow::follow_object, blurt::plugins::follow::follow_index )

FC_REFLECT( blurt::plugins::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( blurt::plugins::follow::feed_object, blurt::plugins::follow::feed_index )
...
FC_REFLECT( blurt::plugins::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( blurt::plugins::follow::blog_author_stats_object, blurt::plugins::follow::blog_author_stats_index );

namespace helpers
{
   template <>
   class index_statistic_provider<blurt::plugins::follow::feed_index>
   {
   public:
      typedef blurt::plugins::follow::feed_index IndexType;
      typedef typename blurt::plugins::follow::feed_object::t_reblogged_by_container t_reblogged_by_container;
