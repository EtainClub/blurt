...
#define BLURT_STATSD_PLUGIN_NAME "statsd"

namespace blurt { namespace plugins { namespace statsd {
...
class statsd_plugin : public appbase::plugin< statsd_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = BLURT_STATSD_PLUGIN_NAME; return name; }
