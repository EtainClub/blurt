#pragma once
#include <blurt/plugins/statsd/statsd_plugin.hpp>
...
using blurt::plugins::statsd::statsd_plugin;
...
if( blurt::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   blurt::plugins::statsd::util::get_statsd().increment( \
...
if( blurt::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   blurt::plugins::statsd::util::get_statsd().decrement( \
      NAMESPACE, STAT, KEY, FREQ                         \
   );                                                    \
}
...
if( blurt::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   blurt::plugins::statsd::util::get_statsd().count(     \
...
if( blurt::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   blurt::plugins::statsd::util::get_statsd().gauge(     \
      NAMESPACE, STAT, KEY, VAL, FREQ                    \
   );                                                    \
}
...
fc::optional< blurt::plugins::statsd::util::statsd_timer_helper > statsd_timer;  \
if( blurt::plugins::statsd::util::statsd_enabled() )                             \
{                                                                                \
   statsd_timer = blurt::plugins::statsd::util::statsd_timer_helper(             \
      NAMESPACE, STAT, KEY, FREQ, blurt::plugins::statsd::util::get_statsd()     \
   );                                                                            \
}
...
if( blurt::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   blurt::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      blurt::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
