...
#include <blurt/plugins/block_log_info/block_log_info_plugin.hpp>
#include <blurt/plugins/block_log_info/block_log_info_objects.hpp>
...
void block_log_info_plugin::plugin_initialize( const boost::program_options::variables_map& options )
{
   ...
   try
   {
      ...
      BLURT_ADD_PLUGIN_INDEX(db, block_log_hash_state_index);
      BLURT_ADD_PLUGIN_INDEX(db, block_log_pending_message_index);
