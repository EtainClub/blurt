...
BLURT_DEFINE_PLUGIN_EVALUATOR( rc_plugin, rc_plugin_operation, delegate_to_pool_operation );
BLURT_DEFINE_PLUGIN_EVALUATOR( rc_plugin, rc_plugin_operation, delegate_drc_from_pool_operation );

} } } // blurt::plugins::rc

FC_REFLECT( blurt::plugins::rc::delegate_to_pool_operation,
   (from_account)
   (to_pool)
   (amount)
   )
FC_REFLECT( blurt::plugins::rc::delegate_drc_from_pool_operation,
   (from_pool)
   (to_account)
   (mana_change)
   (drc_max_mana)
...
BLURT_DECLARE_OPERATION_TYPE( blurt::plugins::rc::rc_plugin_operation )
FC_REFLECT_TYPENAME( blurt::plugins::rc::rc_plugin_operation )
