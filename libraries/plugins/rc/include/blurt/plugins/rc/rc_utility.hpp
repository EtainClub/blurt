...
using blurt::chain::util::rd_decay_params;
using blurt::chain::util::rd_dynamics_params;
using blurt::chain::util::rd_compute_pool_decay;
...
FC_REFLECT( blurt::plugins::rc::rc_price_curve_params, (coeff_a)(coeff_b)(shift) )
FC_REFLECT( blurt::plugins::rc::rc_resource_params, (resource_dynamics_params)(price_curve_params) )
