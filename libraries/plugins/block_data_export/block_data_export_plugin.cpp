...
namespace blurt { namespace plugins { namespace block_data_export {
...
FC_REFLECT( blurt::plugins::block_data_export::detail::api_export_data_object, (block_id)(previous)(export_data) )

namespace blurt { namespace plugins { namespace block_data_export { namespace detail {
...
} } } // blurt::plugins::block_data_export
