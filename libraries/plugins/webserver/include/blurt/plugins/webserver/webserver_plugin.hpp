...
#define BLURT_WEBSERVER_PLUGIN_NAME "webserver"

namespace blurt { namespace plugins { namespace webserver {
...
class webserver_plugin : public appbase::plugin< webserver_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = BLURT_WEBSERVER_PLUGIN_NAME; return name; }
