...
namespace blurt { namespace plugins { namespace test_api {
...
class test_api_plugin : public appbase::plugin< test_api_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = BLURT_TEST_API_PLUGIN_NAME; return name; }
