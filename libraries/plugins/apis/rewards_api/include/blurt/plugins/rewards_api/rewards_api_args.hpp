...
FC_REFLECT( blurt::plugins::rewards_api::simulate_curve_payouts_element, (author)(permlink)(payout) )
FC_REFLECT( blurt::plugins::rewards_api::simulate_curve_payouts_args, (curve)(var1) )
FC_REFLECT( blurt::plugins::rewards_api::simulate_curve_payouts_return, (recent_claims)(payouts) )
