...
FC_REFLECT( blurt::plugins::database_api::api_comment_object,
             (id)(author)(permlink)
...
FC_REFLECT( blurt::plugins::database_api::api_comment_vote_object,
             (id)(voter)(author)(permlink)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )

FC_REFLECT( blurt::plugins::database_api::api_account_object,
...
FC_REFLECT( blurt::plugins::database_api::api_owner_authority_history_object,
             (id)
             (account)
...
FC_REFLECT( blurt::plugins::database_api::api_account_recovery_request_object,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( blurt::plugins::database_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( blurt::plugins::database_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT_DERIVED( blurt::plugins::database_api::api_signed_block_object, (blurt::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT( blurt::plugins::database_api::api_hardfork_property_object,
            (id)
            (processed_hardforks)
            (last_hardfork)
...
FC_REFLECT_ENUM( blurt::plugins::database_api::proposal_status,
                  (all)
                  (inactive)
                  (active)
                  (expired)
...
FC_REFLECT( blurt::plugins::database_api::api_proposal_object,
            (id)
            (proposal_id)
            (creator)
            (receiver)
...
FC_REFLECT( blurt::plugins::database_api::api_proposal_vote_object,
            (id)
            (voter)
            (proposal)
          )
