...
FC_REFLECT_ENUM( blurt::plugins::database_api::order_direction_type,
  (ascending)
  (descending) )

FC_REFLECT( blurt::plugins::database_api::list_object_args_type,
   (start)(limit)(order) )

FC_REFLECT( blurt::plugins::database_api::get_reward_funds_return,
   (funds) )

FC_REFLECT( blurt::plugins::database_api::list_witnesses_return,
   (witnesses) )

FC_REFLECT( blurt::plugins::database_api::find_witnesses_args,
   (owners) )

FC_REFLECT( blurt::plugins::database_api::list_witness_votes_return,
   (votes) )

FC_REFLECT( blurt::plugins::database_api::get_active_witnesses_return,
   (witnesses) )

FC_REFLECT( blurt::plugins::database_api::list_accounts_return,
   (accounts) )

FC_REFLECT( blurt::plugins::database_api::find_accounts_args,
   (accounts) )

FC_REFLECT( blurt::plugins::database_api::list_owner_histories_args,
   (start)(limit) )

FC_REFLECT( blurt::plugins::database_api::list_owner_histories_return,
   (owner_auths) )

FC_REFLECT( blurt::plugins::database_api::find_owner_histories_args,
   (owner) )

FC_REFLECT( blurt::plugins::database_api::list_account_recovery_requests_return,
   (requests) )

FC_REFLECT( blurt::plugins::database_api::find_account_recovery_requests_args,
   (accounts) )

FC_REFLECT(
   blurt::plugins::database_api::list_change_recovery_account_requests_return,
   (requests) )

FC_REFLECT( blurt::plugins::database_api::find_change_recovery_account_requests_args,
   (accounts) )

FC_REFLECT( blurt::plugins::database_api::list_escrows_return,
   (escrows) )

FC_REFLECT( blurt::plugins::database_api::find_escrows_args,
   (from) )

FC_REFLECT( blurt::plugins::database_api::list_withdraw_vesting_routes_return,
   (routes) )

FC_REFLECT( blurt::plugins::database_api::find_withdraw_vesting_routes_args,
   (account)(order) )

FC_REFLECT( blurt::plugins::database_api::list_savings_withdrawals_return,
   (withdrawals) )

FC_REFLECT( blurt::plugins::database_api::find_savings_withdrawals_args,
   (account) )

FC_REFLECT( blurt::plugins::database_api::list_vesting_delegations_return,
   (delegations) )

FC_REFLECT( blurt::plugins::database_api::find_vesting_delegations_args,
   (account) )

FC_REFLECT( blurt::plugins::database_api::list_vesting_delegation_expirations_return,
   (delegations) )

FC_REFLECT( blurt::plugins::database_api::find_vesting_delegation_expirations_args,
   (account) )

FC_REFLECT( blurt::plugins::database_api::list_decline_voting_rights_requests_return,
   (requests) )

FC_REFLECT( blurt::plugins::database_api::find_decline_voting_rights_requests_args,
   (accounts) )

FC_REFLECT( blurt::plugins::database_api::list_comments_return,
   (comments) )

FC_REFLECT( blurt::plugins::database_api::find_comments_args,
   (comments) )

FC_REFLECT( blurt::plugins::database_api::list_votes_return,
   (votes) )

FC_REFLECT( blurt::plugins::database_api::find_votes_args,
   (author)(permlink) )

FC_REFLECT( blurt::plugins::database_api::list_proposals_args,
   (start)(limit)(order)(order_direction)(status) )

FC_REFLECT( blurt::plugins::database_api::list_proposals_return,
   (proposals) )

FC_REFLECT( blurt::plugins::database_api::find_proposals_args,
   (proposal_ids) )

FC_REFLECT( blurt::plugins::database_api::list_proposal_votes_return,
   (proposal_votes) )

FC_REFLECT( blurt::plugins::database_api::get_transaction_hex_args,
   (trx) )

FC_REFLECT( blurt::plugins::database_api::get_transaction_hex_return,
   (hex) )

FC_REFLECT( blurt::plugins::database_api::get_required_signatures_args,
   (trx)
   (available_keys) )

FC_REFLECT( blurt::plugins::database_api::get_required_signatures_return,
   (keys) )

FC_REFLECT( blurt::plugins::database_api::get_potential_signatures_args,
   (trx) )

FC_REFLECT( blurt::plugins::database_api::verify_authority_args,
   (trx) )

FC_REFLECT( blurt::plugins::database_api::verify_authority_return,
   (valid) )

FC_REFLECT( blurt::plugins::database_api::verify_account_authority_args,
   (account)
   (signers) )

FC_REFLECT( blurt::plugins::database_api::verify_signatures_args,
   (hash)
   (signatures)
   (required_owner)
   (required_active)
...
FC_REFLECT( blurt::plugins::database_api::verify_signatures_return,
   (valid) )
