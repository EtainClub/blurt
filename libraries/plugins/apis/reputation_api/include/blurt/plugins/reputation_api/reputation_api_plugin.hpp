...
#define BLURT_REPUTATION_API_PLUGIN_NAME "reputation_api"
...
public:
   APPBASE_PLUGIN_REQUIRES(
      (blurt::plugins::reputation::reputation_plugin)
   ...
   static const std::string& name() { static std::string name = BLURT_REPUTATION_API_PLUGIN_NAME; return name; }
