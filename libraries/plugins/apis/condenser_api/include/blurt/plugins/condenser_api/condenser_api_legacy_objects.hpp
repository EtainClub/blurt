...
void to_variant( const blurt::plugins::condenser_api::legacy_block_header_extensions&, fc::variant& );
void from_variant( const fc::variant&, blurt::plugins::condenser_api::legacy_block_header_extensions& );
