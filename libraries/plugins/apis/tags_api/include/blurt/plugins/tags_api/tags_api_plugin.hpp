...
#define BLURT_TAGS_API_PLUGIN_NAME "tags_api"
...
public:
   APPBASE_PLUGIN_REQUIRES(
      (blurt::plugins::tags::tags_plugin)
   ...
   static const std::string& name() { static std::string name = BLURT_TAGS_API_PLUGIN_NAME; return name; }
