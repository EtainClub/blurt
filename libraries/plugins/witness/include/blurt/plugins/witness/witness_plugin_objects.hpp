...
{
   witness_custom_op_object_type          = ( BLURT_WITNESS_SPACE_ID << 8 )
};
...
FC_REFLECT( blurt::plugins::witness::witness_custom_op_object,
   (id)
   (account)
   (count)
   )
CHAINBASE_SET_INDEX_TYPE( blurt::plugins::witness::witness_custom_op_object, blurt::plugins::witness::witness_custom_op_index )
