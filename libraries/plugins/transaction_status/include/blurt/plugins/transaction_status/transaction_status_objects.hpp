...
namespace blurt { namespace plugins { namespace transaction_status {

using namespace blurt::chain;

#ifndef BLURT_TRANSACTION_STATUS_SPACE_ID
#define BLURT_TRANSACTION_STATUS_SPACE_ID 18
#endif

enum transaction_status_object_type
{
   transaction_status_object_type = ( BLURT_TRANSACTION_STATUS_SPACE_ID << 8 )
};
...
} } } // blurt::plugins::transaction_status

FC_REFLECT_ENUM( blurt::plugins::transaction_status::transaction_status,
                (unknown)
                (within_mempool)
...
FC_REFLECT( blurt::plugins::transaction_status::transaction_status_object, (id)(transaction_id)(block_num) )
CHAINBASE_SET_INDEX_TYPE( blurt::plugins::transaction_status::transaction_status_object, blurt::plugins::transaction_status::transaction_status_index )
