...
#define BLURT_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
BLURT_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define BLURT_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define BLURT_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define BLURT_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
BLURT_DECLARE_SCHEMA_CLASS( false, false )
BLURT_DECLARE_SCHEMA_CLASS(  true, false )
BLURT_DECLARE_SCHEMA_CLASS(  true,  true )
