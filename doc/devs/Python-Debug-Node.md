...
To use the script include `from blurtdebugnode import DebugNode`
...
[debugnode.py](https://github.com/steemit/steem/python_scripts/blurtdebugnode/debugnode.py#L212)
...
specify the blurtd binary location and a populated data directory. For most configurations
