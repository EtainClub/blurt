...
# local imports
from blurtdebugnode import DebugNode
...
def main( ):
   ...
   parser = ArgumentParser( description='Run a blurtd debug node on an existing chain, trigger a hardfork' \
...
def run_blurtd_tests( debug_node ):
   from steemapi.steemnoderpc import SteemNodeRPC
